package com.abc.pservice.service;
...
import com.abc.pservice.exception.ProductNotFoundException;
import com.abc.pservice.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService{
	...
	public List<Product> getProductWithinPriceRange(double minPrice, double maxPrice) {
		List<Product> products = productRepository.filterByProductPriceRange(minPrice, maxPrice);
		return products;
	}	
